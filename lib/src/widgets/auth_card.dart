              ...
              : index == 1
                  ...
                  : index == 2
                      ...
                      : _RegisterNoticeCard(
                          ...
                          message: '''
歡迎使用台灣中油股份有限公司（以下簡稱本公司）所提供之應用程式（以下稱本行動應用程式），為了讓您能夠安心的使用本行動應用程式的各項服務與資訊，特此向您說明本行動應用程式的隱私權保護政策，以保障您的權益，請詳閱下列內容：

一、 隱私權保護政策的適用範圍
    隱私權保護政策內容，包括本行動應用程式如何處理在您使用行動應用程式服務時收集到的個人識別資料。隱私權保護政策不適用於本行動應用程式以外的相關連結網站，也不適用於非本行動應用程式所委託或參與管理的人員。

二、 個人資料隱私條款政策事項
    1. 於本行動應用程式註冊成功後，將取得特定帳號（手機號碼）及密碼，您務必維持其帳號與密碼之機密安全，依本行動應用程式輸入帳號及密碼原則，無論是否為本人或藉由他人使用，均視為使用者本人使用，利用該帳號進行本行動應用程式一切行動，您需負完全責任。
    2. 帳號及密碼為您使用本服務之權利，請妥善保管您的帳號，不得轉借、轉讓或與他人合用帳號，並建議您不定期更改密碼，若因帳號密碼外洩造成損害，台灣中油股份有限公司將不負任何賠償責任。
    3. 使用者應自行確實保管所使用之裝置、設備及相關登入資訊之安全，防止他人窺視、非法使用、取得登入資訊、竄改基本身份資料、毀損紀錄等情形。非經您同意、依法律之規定，絕不會將您的個人資料透漏予任何與台灣中油股份有限公司無關之第三人。
    4. 本行動應用程式於使用者註冊及登入頁面未就姓名、手機號碼、電子郵件地址欄位進行遮蔽，以利使用者於註冊或登入時得透過介面確認其所輸入之資訊無誤；另因使用者需輸入密碼登入後方得查看其個人資訊如帳號、手機號碼與Email，且前述資料非屬支付工具（如信用卡卡號及驗證資料）等高風險資訊，故本行動應用程式未於介面就前述資訊進行遮蔽。
    5. 若您發現並懷疑帳號遭人盜用或不當使用，應立即通知本公司，以利採取適當應變措施；經上述措施不得要求本公司對使用者負有任何形式之賠償或補償義務。

三、 個人資料的蒐集、處理及利用方式
    當您造訪本行動應用程式或使用本行動應用程式所提供之功能服務時，我們將視該服務功能性質，請您提供必要的個人資料（包括但不限於姓名、行動電話號碼、電子郵件地址、地理位置及其他依法受保護之資料等），並在該特定目的範圍內處理及利用您的個人資料。

四、 與第三人共用個人資料之政策
    本行動應用程式絕不會提供、交換、出租或出售任何您的個人資料給其他個人、團體、私人企業或公務機關，但有法律依據或合約義務者，不在此限。
    前項但書之情形包括不限於：
    1. 經由您書面同意。
    2. 法律明文規定。
